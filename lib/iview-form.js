...
var getPrefix = function getPrefix(taglib) {
  var elementMap = {
    'form': 'el-form',
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
      ...
      let obj = {
        ...
        on: __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, itemOn, {
          input: function input(value) {
            ...
            let refObj = {}
            if(item.ref){
              refObj[item.ref] = _this6.$refs[item.ref]
            }
            _this6.form[item.key] = value;
            _this6.emitInput(value, item, refObj);
          }
        }, on),
    ...
    // 触发 item onInput 事件
    emitInput: function emitInput(value, item, refObj) {
    ...
    submit: function submit() {
      ...
      this.$refs.form.validate(function (valid) {
        _this7.$emit('submit', _this7.getForm(), valid, _this7.$refs);
      });
    },
