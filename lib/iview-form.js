  ...
  methods: {
    ...
    getFormList: function getFormList(h) {
      ...
      return this.formList.map(function (item) {
        return _this2.getFormItem(h, item, _this2.getContent(h, item));
      });
    },
    ...
    getFormListByNumber: function getFormListByNumber(h) {
      ...
      var formList = this.formList.filter(function (children) {
        var isShow = children.hasOwnProperty('isShow') ? children.isShow : true;
        var hasRow = children.hasOwnProperty('hasRow') ? children.hasRow : true;
      ...
      var tag = {
        ...
        nativeOn: {
          keydown: function keydown(e) {
            if (e.keyCode === 13 && _this3.enterSubmit && props.type !== 'textarea') {
              _this3.submit();
            }
          }
        }
      ...
      var obj = {
        ...
        on: __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, itemOn, {
          input: function input(value) {
            value = _this4.formatDateValue(value, item);
            var refObj = {};
            if (item.ref) {
              refObj[item.ref] = _this.$refs[item.ref];
            }
            _this4.form[item.key] = value;
            _this4.emitInput(value, item, refObj, _this.$refs);
          }
        }, on),
    ...
    submit: function submit() {
      ...
      this.$refs.form.validate(function (valid) {
        _this5.$emit('submit', _this5.getForm(), valid, _this5.$refs);
      });
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__packages_iview_form__ = __webpack_require__(13);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__iview_form__ = __webpack_require__(14);
